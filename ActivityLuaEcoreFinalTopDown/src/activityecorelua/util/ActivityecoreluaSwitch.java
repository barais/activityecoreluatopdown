 ...
 * @generated
 */
public class ActivityecoreluaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ActivityecoreluaPackage.EOBJECT: {
				activityecorelua.EObject eObject = (activityecorelua.EObject)theEObject;
			...
			case ActivityecoreluaPackage.EPACKAGE: {
				activityecorelua.EPackage ePackage = (activityecorelua.EPackage)theEObject;
	 ...
	 * @generated
	 */
	public T caseEObject(activityecorelua.EObject object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseEPackage(activityecorelua.EPackage object) {
		return null;
	}
