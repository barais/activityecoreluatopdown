 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.InputImpl#getInputValues <em>Input Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends MinimalEObjectImpl.Container implements Input {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.INPUT;
	}
	...
	public EList<InputValue> getInputValues() {
		if (inputValues == null) {
			inputValues = new EObjectContainmentEList<InputValue>(InputValue.class, this, ActivityecoreluaPackage.INPUT__INPUT_VALUES);
		}
		return inputValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.INPUT__INPUT_VALUES:
