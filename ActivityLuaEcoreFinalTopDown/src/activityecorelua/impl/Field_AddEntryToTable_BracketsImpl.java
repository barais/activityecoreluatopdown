 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.Field_AddEntryToTable_BracketsImpl#getIndexExpression <em>Index Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Field_AddEntryToTable_BracketsImpl extends FieldImpl implements Field_AddEntryToTable_Brackets {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS;
	}
	...
	public NotificationChain basicSetIndexExpression(Expression newIndexExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS__INDEX_EXPRESSION, oldIndexExpression, newIndexExpression);
	...
	public void setIndexExpression(Expression newIndexExpression) {
		if (newIndexExpression != indexExpression) {
			...
			if (indexExpression != null)
				msgs = ((InternalEObject)indexExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS__INDEX_EXPRESSION, null, msgs);
			if (newIndexExpression != null)
				msgs = ((InternalEObject)newIndexExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS__INDEX_EXPRESSION, null, msgs);
			msgs = basicSetIndexExpression(newIndexExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS__INDEX_EXPRESSION, newIndexExpression, newIndexExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.FIELD_ADD_ENTRY_TO_TABLE_BRACKETS__INDEX_EXPRESSION:
