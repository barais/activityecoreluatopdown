 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.Expression_VariableNameImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Expression_VariableNameImpl extends ExpressionImpl implements Expression_VariableName {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EXPRESSION_VARIABLE_NAME;
	}
	...
	public void setVariable(String newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EXPRESSION_VARIABLE_NAME__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.EXPRESSION_VARIABLE_NAME__VARIABLE:
				return getVariable();
		}
