 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EModelElementImpl#getEAnnotations <em>EAnnotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EModelElementImpl extends MinimalEObjectImpl.Container implements EModelElement {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EMODEL_ELEMENT;
	}
	...
	public EList<EAnnotation> getEAnnotations() {
		if (eAnnotations == null) {
			eAnnotations = new EObjectContainmentWithInverseEList<EAnnotation>(EAnnotation.class, this, ActivityecoreluaPackage.EMODEL_ELEMENT__EANNOTATIONS, ActivityecoreluaPackage.EANNOTATION__EMODEL_ELEMENT);
		}
		return eAnnotations;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.EMODEL_ELEMENT__EANNOTATIONS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ActivityecoreluaPackage.EMODEL_ELEMENT___GET_EANNOTATION__STRING:
