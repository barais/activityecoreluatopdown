 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EAttributeImpl#isID <em>ID</em>}</li>
 *   <li>{@link activityecorelua.impl.EAttributeImpl#getEAttributeType <em>EAttribute Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EAttributeImpl extends EStructuralFeatureImpl implements EAttribute {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EATTRIBUTE;
	}
	...
	public void setID(boolean newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EATTRIBUTE__ID, oldID, iD));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.EATTRIBUTE__ID:
				return isID();
			case ActivityecoreluaPackage.EATTRIBUTE__EATTRIBUTE_TYPE:
