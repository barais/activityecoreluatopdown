 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EClassImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#isInterface <em>Interface</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getESuperTypes <em>ESuper Types</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEOperations <em>EOperations</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllAttributes <em>EAll Attributes</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllReferences <em>EAll References</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEReferences <em>EReferences</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAttributes <em>EAttributes</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllContainments <em>EAll Containments</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllOperations <em>EAll Operations</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllStructuralFeatures <em>EAll Structural Features</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllSuperTypes <em>EAll Super Types</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEIDAttribute <em>EID Attribute</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEStructuralFeatures <em>EStructural Features</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEGenericSuperTypes <em>EGeneric Super Types</em>}</li>
 *   <li>{@link activityecorelua.impl.EClassImpl#getEAllGenericSuperTypes <em>EAll Generic Super Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EClassImpl extends EClassifierImpl implements EClass {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.ECLASS;
	}
	...
	public void setAbstract(boolean newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ECLASS__ABSTRACT, oldAbstract, abstract_));
	}
	...
	public void setInterface(boolean newInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ECLASS__INTERFACE, oldInterface, interface_));
	}
	...
	public EList<EClass> getESuperTypes() {
		if (eSuperTypes == null) {
			eSuperTypes = new EObjectResolvingEList.Unsettable<EClass>(EClass.class, this, ActivityecoreluaPackage.ECLASS__ESUPER_TYPES);
		}
		return eSuperTypes;
	}
	...
	public EList<EOperation> getEOperations() {
		if (eOperations == null) {
			eOperations = new EObjectContainmentWithInverseEList<EOperation>(EOperation.class, this, ActivityecoreluaPackage.ECLASS__EOPERATIONS, ActivityecoreluaPackage.EOPERATION__ECONTAINING_CLASS);
		}
		return eOperations;
	}
	...
	public EList<EStructuralFeature> getEStructuralFeatures() {
		if (eStructuralFeatures == null) {
			eStructuralFeatures = new EObjectContainmentWithInverseEList<EStructuralFeature>(EStructuralFeature.class, this, ActivityecoreluaPackage.ECLASS__ESTRUCTURAL_FEATURES, ActivityecoreluaPackage.ESTRUCTURAL_FEATURE__ECONTAINING_CLASS);
		}
	...
	public EList<EGenericType> getEGenericSuperTypes() {
		if (eGenericSuperTypes == null) {
			eGenericSuperTypes = new EObjectContainmentEList.Unsettable<EGenericType>(EGenericType.class, this, ActivityecoreluaPackage.ECLASS__EGENERIC_SUPER_TYPES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.ECLASS__EOPERATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getEOperations()).basicAdd(otherEnd, msgs);
			case ActivityecoreluaPackage.ECLASS__ESTRUCTURAL_FEATURES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ActivityecoreluaPackage.ECLASS__EGENERIC_SUPER_TYPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.ECLASS__ABSTRACT:
				return isAbstract();
			case ActivityecoreluaPackage.ECLASS__INTERFACE:
				return isInterface();
			case ActivityecoreluaPackage.ECLASS__ESUPER_TYPES:
				return getESuperTypes();
			case ActivityecoreluaPackage.ECLASS__EOPERATIONS:
				return getEOperations();
			case ActivityecoreluaPackage.ECLASS__EALL_ATTRIBUTES:
				return getEAllAttributes();
			case ActivityecoreluaPackage.ECLASS__EALL_REFERENCES:
				return getEAllReferences();
			case ActivityecoreluaPackage.ECLASS__EREFERENCES:
				return getEReferences();
			case ActivityecoreluaPackage.ECLASS__EATTRIBUTES:
				return getEAttributes();
			case ActivityecoreluaPackage.ECLASS__EALL_CONTAINMENTS:
				return getEAllContainments();
			case ActivityecoreluaPackage.ECLASS__EALL_OPERATIONS:
				return getEAllOperations();
			case ActivityecoreluaPackage.ECLASS__EALL_STRUCTURAL_FEATURES:
				return getEAllStructuralFeatures();
			case ActivityecoreluaPackage.ECLASS__EALL_SUPER_TYPES:
				return getEAllSuperTypes();
			case ActivityecoreluaPackage.ECLASS__EID_ATTRIBUTE:
				return getEIDAttribute();
			case ActivityecoreluaPackage.ECLASS__ESTRUCTURAL_FEATURES:
				return getEStructuralFeatures();
			case ActivityecoreluaPackage.ECLASS__EGENERIC_SUPER_TYPES:
				return getEGenericSuperTypes();
			case ActivityecoreluaPackage.ECLASS__EALL_GENERIC_SUPER_TYPES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ActivityecoreluaPackage.ECLASS___IS_SUPER_TYPE_OF__ECLASS:
				return isSuperTypeOf((EClass)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_FEATURE_COUNT:
				return getFeatureCount();
			case ActivityecoreluaPackage.ECLASS___GET_ESTRUCTURAL_FEATURE__INT:
				return getEStructuralFeature((Integer)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_FEATURE_ID__ESTRUCTURALFEATURE:
				return getFeatureID((EStructuralFeature)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_ESTRUCTURAL_FEATURE__STRING:
				return getEStructuralFeature((String)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_OPERATION_COUNT:
				return getOperationCount();
			case ActivityecoreluaPackage.ECLASS___GET_EOPERATION__INT:
				return getEOperation((Integer)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_OPERATION_ID__EOPERATION:
				return getOperationID((EOperation)arguments.get(0));
			case ActivityecoreluaPackage.ECLASS___GET_OVERRIDE__EOPERATION:
