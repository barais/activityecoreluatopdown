 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.ETypeParameterImpl#getEBounds <em>EBounds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ETypeParameterImpl extends ENamedElementImpl implements ETypeParameter {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.ETYPE_PARAMETER;
	}
	...
	public EList<EGenericType> getEBounds() {
		if (eBounds == null) {
			eBounds = new EObjectContainmentEList<EGenericType>(EGenericType.class, this, ActivityecoreluaPackage.ETYPE_PARAMETER__EBOUNDS);
		}
		return eBounds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.ETYPE_PARAMETER__EBOUNDS:
