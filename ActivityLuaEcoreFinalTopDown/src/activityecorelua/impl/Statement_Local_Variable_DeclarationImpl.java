 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.Statement_Local_Variable_DeclarationImpl#getVariableNames <em>Variable Names</em>}</li>
 *   <li>{@link activityecorelua.impl.Statement_Local_Variable_DeclarationImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Statement_Local_Variable_DeclarationImpl extends StatementImpl implements Statement_Local_Variable_Declaration {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.STATEMENT_LOCAL_VARIABLE_DECLARATION;
	}
	...
	public EList<String> getVariableNames() {
		if (variableNames == null) {
			variableNames = new EDataTypeEList<String>(String.class, this, ActivityecoreluaPackage.STATEMENT_LOCAL_VARIABLE_DECLARATION__VARIABLE_NAMES);
		}
	...
	public EList<Expression> getInitialValue() {
		if (initialValue == null) {
			initialValue = new EObjectContainmentEList<Expression>(Expression.class, this, ActivityecoreluaPackage.STATEMENT_LOCAL_VARIABLE_DECLARATION__INITIAL_VALUE);
		}
		return initialValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.STATEMENT_LOCAL_VARIABLE_DECLARATION__INITIAL_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.STATEMENT_LOCAL_VARIABLE_DECLARATION__VARIABLE_NAMES:
