 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.Expression_TableConstructorImpl#getFields <em>Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Expression_TableConstructorImpl extends ExpressionImpl implements Expression_TableConstructor {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EXPRESSION_TABLE_CONSTRUCTOR;
	}
	...
	public EList<Field> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<Field>(Field.class, this, ActivityecoreluaPackage.EXPRESSION_TABLE_CONSTRUCTOR__FIELDS);
		}
		return fields;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.EXPRESSION_TABLE_CONSTRUCTOR__FIELDS:
