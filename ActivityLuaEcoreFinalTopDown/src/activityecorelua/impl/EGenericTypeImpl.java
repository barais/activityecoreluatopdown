 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getEUpperBound <em>EUpper Bound</em>}</li>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getETypeArguments <em>EType Arguments</em>}</li>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getERawType <em>ERaw Type</em>}</li>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getELowerBound <em>ELower Bound</em>}</li>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getETypeParameter <em>EType Parameter</em>}</li>
 *   <li>{@link activityecorelua.impl.EGenericTypeImpl#getEClassifier <em>EClassifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EGenericTypeImpl extends MinimalEObjectImpl.Container implements EGenericType {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EGENERIC_TYPE;
	}
	...
	public NotificationChain basicSetEUpperBound(EGenericType newEUpperBound, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__EUPPER_BOUND, oldEUpperBound, newEUpperBound);
	...
	public void setEUpperBound(EGenericType newEUpperBound) {
		if (newEUpperBound != eUpperBound) {
			...
			if (eUpperBound != null)
				msgs = ((InternalEObject)eUpperBound).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.EGENERIC_TYPE__EUPPER_BOUND, null, msgs);
			if (newEUpperBound != null)
				msgs = ((InternalEObject)newEUpperBound).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.EGENERIC_TYPE__EUPPER_BOUND, null, msgs);
			msgs = basicSetEUpperBound(newEUpperBound, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__EUPPER_BOUND, newEUpperBound, newEUpperBound));
	}
	...
	public EList<EGenericType> getETypeArguments() {
		if (eTypeArguments == null) {
			eTypeArguments = new EObjectContainmentEList<EGenericType>(EGenericType.class, this, ActivityecoreluaPackage.EGENERIC_TYPE__ETYPE_ARGUMENTS);
		}
	...
	public EClassifier getERawType() {
		if (eRawType != null && eRawType.eIsProxy()) {
			...
			if (eRawType != oldERawType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityecoreluaPackage.EGENERIC_TYPE__ERAW_TYPE, oldERawType, eRawType));
			}
		}
		return eRawType;
	}
	...
	public NotificationChain basicSetELowerBound(EGenericType newELowerBound, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND, oldELowerBound, newELowerBound);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setELowerBound(EGenericType newELowerBound) {
		if (newELowerBound != eLowerBound) {
			NotificationChain msgs = null;
			if (eLowerBound != null)
				msgs = ((InternalEObject)eLowerBound).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND, null, msgs);
			if (newELowerBound != null)
				msgs = ((InternalEObject)newELowerBound).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND, null, msgs);
			msgs = basicSetELowerBound(newELowerBound, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND, newELowerBound, newELowerBound));
	}
	...
	public void setETypeParameter(ETypeParameter newETypeParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__ETYPE_PARAMETER, oldETypeParameter, eTypeParameter));
	}
	...
	public EClassifier getEClassifier() {
		if (eClassifier != null && eClassifier.eIsProxy()) {
			...
			if (eClassifier != oldEClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityecoreluaPackage.EGENERIC_TYPE__ECLASSIFIER, oldEClassifier, eClassifier));
			}
		}
		return eClassifier;
	}
	...
	public void setEClassifier(EClassifier newEClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EGENERIC_TYPE__ECLASSIFIER, oldEClassifier, eClassifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.EGENERIC_TYPE__EUPPER_BOUND:
				return basicSetEUpperBound(null, msgs);
			case ActivityecoreluaPackage.EGENERIC_TYPE__ETYPE_ARGUMENTS:
				return ((InternalEList<?>)getETypeArguments()).basicRemove(otherEnd, msgs);
			case ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ActivityecoreluaPackage.EGENERIC_TYPE__ERAW_TYPE:
				if (resolve) return getERawType();
				return basicGetERawType();
			case ActivityecoreluaPackage.EGENERIC_TYPE__ELOWER_BOUND:
				return getELowerBound();
			case ActivityecoreluaPackage.EGENERIC_TYPE__ETYPE_PARAMETER:
				return getETypeParameter();
			case ActivityecoreluaPackage.EGENERIC_TYPE__ECLASSIFIER:
