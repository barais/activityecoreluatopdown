 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.Statement_If_Then_Else_ElseIfPartImpl#getElseifExpression <em>Elseif Expression</em>}</li>
 *   <li>{@link activityecorelua.impl.Statement_If_Then_Else_ElseIfPartImpl#getElseifBlock <em>Elseif Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Statement_If_Then_Else_ElseIfPartImpl extends MinimalEObjectImpl.Container implements Statement_If_Then_Else_ElseIfPart {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART;
	}
	...
	public NotificationChain basicSetElseifExpression(Expression newElseifExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_EXPRESSION, oldElseifExpression, newElseifExpression);
	...
	public void setElseifExpression(Expression newElseifExpression) {
		if (newElseifExpression != elseifExpression) {
			...
			if (elseifExpression != null)
				msgs = ((InternalEObject)elseifExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_EXPRESSION, null, msgs);
			if (newElseifExpression != null)
				msgs = ((InternalEObject)newElseifExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_EXPRESSION, null, msgs);
			msgs = basicSetElseifExpression(newElseifExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_EXPRESSION, newElseifExpression, newElseifExpression));
	}
	...
	public NotificationChain basicSetElseifBlock(Block newElseifBlock, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_BLOCK, oldElseifBlock, newElseifBlock);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElseifBlock(Block newElseifBlock) {
		if (newElseifBlock != elseifBlock) {
			NotificationChain msgs = null;
			if (elseifBlock != null)
				msgs = ((InternalEObject)elseifBlock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_BLOCK, null, msgs);
			if (newElseifBlock != null)
				msgs = ((InternalEObject)newElseifBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_BLOCK, null, msgs);
			msgs = basicSetElseifBlock(newElseifBlock, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_BLOCK, newElseifBlock, newElseifBlock));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_EXPRESSION:
				return basicSetElseifExpression(null, msgs);
			case ActivityecoreluaPackage.STATEMENT_IF_THEN_ELSE_ELSE_IF_PART__ELSEIF_BLOCK:
