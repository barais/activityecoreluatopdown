 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.ENamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ENamedElementImpl extends EModelElementImpl implements ENamedElement {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.ENAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ENAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.ENAMED_ELEMENT__NAME:
				return getName();
		}
