 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EDataTypeImpl#isSerializable <em>Serializable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EDataTypeImpl extends EClassifierImpl implements EDataType {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EDATA_TYPE;
	}
	...
	public void setSerializable(boolean newSerializable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EDATA_TYPE__SERIALIZABLE, oldSerializable, serializable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.EDATA_TYPE__SERIALIZABLE:
