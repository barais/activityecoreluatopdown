 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#isContainment <em>Containment</em>}</li>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#isContainer <em>Container</em>}</li>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#isResolveProxies <em>Resolve Proxies</em>}</li>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#getEOpposite <em>EOpposite</em>}</li>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#getEReferenceType <em>EReference Type</em>}</li>
 *   <li>{@link activityecorelua.impl.EReferenceImpl#getEKeys <em>EKeys</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EReferenceImpl extends EStructuralFeatureImpl implements EReference {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.EREFERENCE;
	}
	...
	public void setContainment(boolean newContainment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EREFERENCE__CONTAINMENT, oldContainment, containment));
	}
	...
	public void setResolveProxies(boolean newResolveProxies) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EREFERENCE__RESOLVE_PROXIES, oldResolveProxies, resolveProxies));
	}
	...
	public EReference getEOpposite() {
		if (eOpposite != null && eOpposite.eIsProxy()) {
			...
			if (eOpposite != oldEOpposite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityecoreluaPackage.EREFERENCE__EOPPOSITE, oldEOpposite, eOpposite));
			}
		}
		return eOpposite;
	}
	...
	public void setEOpposite(EReference newEOpposite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.EREFERENCE__EOPPOSITE, oldEOpposite, eOpposite));
	}
	 ...
	 * @generated
	 */
	public activityecorelua.EClass getEReferenceType() {
		activityecorelua.EClass eReferenceType = basicGetEReferenceType();
		return eReferenceType != null && eReferenceType.eIsProxy() ? (activityecorelua.EClass)eResolveProxy((InternalEObject)eReferenceType) : eReferenceType;
	}
	 ...
	 * @generated
	 */
	public activityecorelua.EClass basicGetEReferenceType() {
	...
	public EList<EAttribute> getEKeys() {
		if (eKeys == null) {
			eKeys = new EObjectResolvingEList<EAttribute>(EAttribute.class, this, ActivityecoreluaPackage.EREFERENCE__EKEYS);
		}
		return eKeys;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.EREFERENCE__CONTAINMENT:
				return isContainment();
			case ActivityecoreluaPackage.EREFERENCE__CONTAINER:
				return isContainer();
			case ActivityecoreluaPackage.EREFERENCE__RESOLVE_PROXIES:
				return isResolveProxies();
			case ActivityecoreluaPackage.EREFERENCE__EOPPOSITE:
				if (resolve) return getEOpposite();
				return basicGetEOpposite();
			case ActivityecoreluaPackage.EREFERENCE__EREFERENCE_TYPE:
				if (resolve) return getEReferenceType();
				return basicGetEReferenceType();
			case ActivityecoreluaPackage.EREFERENCE__EKEYS:
				return getEKeys();
		}
