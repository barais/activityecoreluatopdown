 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.ControlFlowImpl#getGuard <em>Guard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlFlowImpl extends ActivityEdgeImpl implements ControlFlow {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.CONTROL_FLOW;
	}
		...
		if (guard != null && guard.eIsProxy()) {
			...
			if (guard != oldGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityecoreluaPackage.CONTROL_FLOW__GUARD, oldGuard, guard));
			}
		}
		return guard;
	}
	...
	public void setGuard(BooleanVariable newGuard) {
		...
		guard = newGuard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.CONTROL_FLOW__GUARD, oldGuard, guard));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.CONTROL_FLOW__GUARD:
