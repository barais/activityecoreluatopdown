 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#isMany <em>Many</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#getEType <em>EType</em>}</li>
 *   <li>{@link activityecorelua.impl.ETypedElementImpl#getEGenericType <em>EGeneric Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ETypedElementImpl extends ENamedElementImpl implements ETypedElement {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.ETYPED_ELEMENT;
	}
	...
	public void setOrdered(boolean newOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ETYPED_ELEMENT__ORDERED, oldOrdered, ordered));
	}
	...
	public void setUnique(boolean newUnique) {
		...
		unique = newUnique;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ETYPED_ELEMENT__UNIQUE, oldUnique, unique));
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ETYPED_ELEMENT__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityecoreluaPackage.ETYPED_ELEMENT__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.ETYPED_ELEMENT__EGENERIC_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityecoreluaPackage.ETYPED_ELEMENT__ORDERED:
				return isOrdered();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__UNIQUE:
				return isUnique();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__LOWER_BOUND:
				return getLowerBound();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__UPPER_BOUND:
				return getUpperBound();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__MANY:
				return isMany();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__REQUIRED:
				return isRequired();
			case ActivityecoreluaPackage.ETYPED_ELEMENT__ETYPE:
