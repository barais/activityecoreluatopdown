 ...
 * </p>
 * <ul>
 *   <li>{@link activityecorelua.impl.LastStatement_ReturnWithValueImpl#getReturnValues <em>Return Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LastStatement_ReturnWithValueImpl extends LastStatement_ReturnImpl implements LastStatement_ReturnWithValue {
	...
	protected EClass eStaticClass() {
		return ActivityecoreluaPackage.Literals.LAST_STATEMENT_RETURN_WITH_VALUE;
	}
	...
	public EList<Expression> getReturnValues() {
		if (returnValues == null) {
			returnValues = new EObjectContainmentEList<Expression>(Expression.class, this, ActivityecoreluaPackage.LAST_STATEMENT_RETURN_WITH_VALUE__RETURN_VALUES);
		}
		return returnValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityecoreluaPackage.LAST_STATEMENT_RETURN_WITH_VALUE__RETURN_VALUES:
